...
static class TypeIds {
	...
	public static readonly TypeId CtorInfos = new(nameof(CtorInfos));
	...
	public static readonly TypeId MemoryKeywords = new(nameof(MemoryKeywords));
	...
	public static readonly TypeId CtorKind = new(nameof(CtorKind));
	public static readonly TypeId SignExtendInfo = new(nameof(SignExtendInfo));
	public static readonly TypeId SizeOverride = new(nameof(SizeOverride));
	public static readonly TypeId BranchSizeInfo = new(nameof(BranchSizeInfo));
	public static readonly TypeId InstrOpInfoFlags = new(nameof(InstrOpInfoFlags));
	public static readonly TypeId MemorySizeInfo = new(nameof(MemorySizeInfo));
	public static readonly TypeId FarMemorySizeInfo = new(nameof(FarMemorySizeInfo));
	...
	public static readonly TypeId InstrOpKind = new(nameof(InstrOpKind));
