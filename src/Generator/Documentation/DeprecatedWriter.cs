...
class DeprecatedWriter {

	public virtual void WriteDeprecated(FileWriter writer, EnumValue value) {
		if (!value.DeprecatedInfo.IsDeprecated) return;
	...
	public virtual void WriteDeprecated(FileWriter writer, Constant value) {
		if (!value.DeprecatedInfo.IsDeprecated) return;
