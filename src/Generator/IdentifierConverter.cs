...
namespace Generator {
	...
	static class IdentifierConverter {
		public static string Field(string name) => Escape(name);
		public static string EnumField(string name) => Escape(name);
		public static string Method(string name) => Escape(name);
		public static string Constant(string name) => Escape(name);
		public static string Argument(string name) => Escape(name);
