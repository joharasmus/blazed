...
namespace Generator.Enums.CSharp {
	...
	sealed class CSharpEnumsGenerator : EnumsGenerator {
		...
		public CSharpEnumsGenerator(GeneratorContext generatorContext)
			...
			toFullFileInfo.Add(TypeIds.FormatterTextKind, new FullEnumFileInfo(CSharpConstants.GetFilename(genTypes, CSharpConstants.BlazedNamespace, nameof(TypeIds.FormatterTextKind) + ".g.cs"), CSharpConstants.BlazedNamespace, CSharpConstants.AnyFormatterDefine));
			toFullFileInfo.Add(TypeIds.MemorySizeOptions, new FullEnumFileInfo(CSharpConstants.GetFilename(genTypes, CSharpConstants.BlazedNamespace, nameof(TypeIds.MemorySizeOptions) + ".g.cs"), CSharpConstants.BlazedNamespace, CSharpConstants.AnyFormatterDefine));
