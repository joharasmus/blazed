...
#pragma warning restore CS8618
		...
		static Info[] GetMemorySizes() {
			...
			var data = new ushort[BlazedConstants.MemorySizeEnumCount] {
			...
			for (int i = 0; i < infos.Length; i++) {
				...
				var keywords = (d & MemoryKeywordsMask) switch {
					...
					// ⚠️This was generated by GENERATOR!🦹‍♂️
					0x00 => Array.Empty<FormatterString>(),
					0x01 => byte_ptr,
					0x02 => dword_bcst,
					0x03 => dword_ptr,
					0x04 => fpuenv14_ptr,
				...
				infos[i] = new Info(i >= (int)BlazedConstants.FirstBroadcastMemorySize, sizes[d >> SizeKindShift], keywords);
			}
