...
namespace Blazed.Intel.DecoderInternal {
	static partial class OpCodeHandlersTables_Legacy {
			...
			new byte[] {
				...
				0x09,// RM
					0x12,// MandatoryPrefix4
						...
						0x02,// Invalid
						0xAB,// Simple5
							0xBE, 0x25,// Via_undoc_F30FA6F0_16
						0x02,// Invalid
						0x00,// 0x0
					0x02,// Invalid
				...
				0x09,// RM
					0x12,// MandatoryPrefix4
						...
						0x02,// Invalid
						0xAB,// Simple5
							0xC1, 0x25,// Via_undoc_F30FA6F8_16
						0x02,// Invalid
						0x00,// 0x0
					0x02,// Invalid
				...
				0x09,// RM
					0x07,// HandlerReference
						0x33,// 0x33 = reservedNop_0F0D
					0x0E,// Group
						0x08,// ArrayReference
							0x3C,// 0x3C = handlers_Grp_0F0D_mem
				...
				0x9E,// Reservednop
					...
					0x09,// RM
						...
						0x0E,// Group
							0x08,// ArrayReference
								0x3E,// 0x3E = handlers_Grp_0F18_mem
				...
				0x9E,// Reservednop
					...
					0x09,// RM
						...
						0x0E,// Group
							0x08,// ArrayReference
								0x40,// 0x40 = handlers_Grp_0F1C_mem
				...
				0x9E,// Reservednop
					...
					0x09,// RM
						0x0F,// Group8x64
							0x08,// ArrayReference
								0x42,// 0x42 = handlers_Grp_0F1E_reg_lo
							0x08,// ArrayReference
								0x44,// 0x44 = handlers_Grp_0F1E_reg_hi
						0x07,// HandlerReference
							0x3A,// 0x3A = reservedNop_0F1E
				...
				0x09,// RM
					0x02,// Invalid
					0x6E,// M_1
						0xA7, 0x21,// Aesencwide128kl_m384

				// 1 = 0x01
				0x09,// RM
					0x02,// Invalid
					0x6E,// M_1
						0xA8, 0x21,// Aesdecwide128kl_m384

				// 2 = 0x02
				0x09,// RM
					0x02,// Invalid
					0x6E,// M_1
						0xA9, 0x21,// Aesencwide256kl_m512

				// 3 = 0x03
				0x09,// RM
					0x02,// Invalid
					0x6E,// M_1
						0xAA, 0x21,// Aesdecwide256kl_m512
				...
				0x11,// MandatoryPrefix
					...
					0x0E,// Group
						0x08,// ArrayReference
							0x49,// 0x49 = handlers_Grp_F30F38D8
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0xB8,// VW_3
						0xAB, 0x21,// Loadiwkey_xmm_xmm
						0xAC, 0x21,// Aesenc128kl_xmm_m384
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0x09,// RM
						0x02,// Invalid
						0xB7,// VW_2
							0xAD, 0x21,// Aesdec128kl_xmm_m384
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0x09,// RM
						0x02,// Invalid
						0xB7,// VW_2
							0xAE, 0x21,// Aesenc256kl_xmm_m512
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0x09,// RM
						0x02,// Invalid
						0xB7,// VW_2
							0xAF, 0x21,// Aesdec256kl_xmm_m512
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0x09,// RM
						0xCD,// Gd_Rd
							0xB0, 0x21,// Encodekey128_r32_r32
						0x02,// Invalid
					0x02,// Invalid
				...
				0x11,// MandatoryPrefix
					...
					0x09,// RM
						0xCD,// Gd_Rd
							0xB1, 0x21,// Encodekey256_r32_r32
						0x02,// Invalid
					0x02,// Invalid
				...
				0x0F,// Group8x64
					0x08,// ArrayReference
						0x4A,// 0x4A = handlers_Grp_0F3AF0_lo
					0x08,// ArrayReference
						0x4B,// 0x4B = handlers_Grp_0F3AF0_hi
				...
				// 25 = 0x19
				0x07,// HandlerReference
					0x35,// 0x35 = reservedNop_0F19

				// 26 = 0x1A
				0x9E,// Reservednop
					0x07,// HandlerReference
						0x36,// 0x36 = reservedNop_0F1A
					0x0C,// Options_DontReadModRM
						0x07,// HandlerReference
							0x36,// 0x36 = reservedNop_0F1A
						0x11,// MandatoryPrefix
				...
				0x0E,// Group
					0x08,// ArrayReference
						0x2E,// 0x2E = handlers_Grp_0F71

				// 114 = 0x72
				0x0E,// Group
					0x08,// ArrayReference
						0x2F,// 0x2F = handlers_Grp_0F72

				// 115 = 0x73
				0x0E,// Group
					0x08,// ArrayReference
						0x30,// 0x30 = handlers_Grp_0F73
				...
				0xC8,// Options1632_1
					0x11,// MandatoryPrefix
						...
						0x0E,// Group
							0x08,// ArrayReference
								0x48,// 0x48 = handlers_Grp_660F78
						0x02,// Invalid
						0xB6,// VRIbIb
							0xDB, 0x0D,// Insertq_xmm_xmm_imm8_imm8
					0xCA,// M_Sw
						0x8F, 0x21,// Svdc_m80_Sreg
					0x80, 0x80, 0x40,// Cyrix
				...
				0xC8,// Options1632_1
					...
					0x0E,// Group
						0x08,// ArrayReference
							0x22,// 0x22 = handlers_Grp_0F7A_Cyrix
					0x80, 0x80, 0x40,// Cyrix
				...
				0xC8,// Options1632_1
					...
					0x0E,// Group
						0x08,// ArrayReference
							0x23,// 0x23 = handlers_Grp_0F7B_Cyrix
					0x80, 0x80, 0x40,// Cyrix
				...
				0xC8,// Options1632_1
					...
					0x0E,// Group
						0x08,// ArrayReference
							0x24,// 0x24 = handlers_Grp_0F7C_Cyrix
					0x80, 0x80, 0x40,// Cyrix
				...
				0xC8,// Options1632_1
					...
					0x0E,// Group
						0x08,// ArrayReference
							0x25,// 0x25 = handlers_Grp_0F7D_Cyrix
					0x80, 0x80, 0x40,// Cyrix
				...
				0x0F,// Group8x64
					0x08,// ArrayReference
						0x31,// 0x31 = handlers_Grp_0FAE_lo
					0x08,// ArrayReference
						0x32,// 0x32 = handlers_Grp_0FAE_hi
				...
				0x0F,// Group8x64
					0x08,// ArrayReference
						0x2A,// 0x2A = handlers_Grp_C6_lo
					0x08,// ArrayReference
						0x2B,// 0x2B = handlers_Grp_C6_hi

				// 199 = 0xC7
				0x0F,// Group8x64
					0x08,// ArrayReference
						0x2C,// 0x2C = handlers_Grp_C7_lo
					0x08,// ArrayReference
						0x2D,// 0x2D = handlers_Grp_C7_hi
		...
		const int MaxIdNames = 80;
		const uint Handlers_MAP0Index = 79;
	}
}
#endif
