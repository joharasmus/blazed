					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xBD, 0x23,// VEX_KNC_Vprefetchnta_m8
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xBE, 0x23,// VEX_KNC_Vprefetch0_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xBF, 0x23,// VEX_KNC_Vprefetch1_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xC0, 0x23,// VEX_KNC_Vprefetch2_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xC1, 0x23,// VEX_KNC_Vprefetchenta_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xC2, 0x23,// VEX_KNC_Vprefetche0_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xC3, 0x23,// VEX_KNC_Vprefetche1_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x1D,// M
									0xC4, 0x23,// VEX_KNC_Vprefetche2_m8
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
						...
						0x0E,// VectorLength
							0x07,// RM
								0x37,// VW_3
									0x4D,// XMM0
									0x4D,// XMM0
									0xAE, 0x21,// VEX_Vbroadcastss_xmm_xmm
								0x37,// VW_3
									0x4D,// XMM0
									0x4D,// XMM0
							...
							0x07,// RM
								0x37,// VW_3
									0x6D,// YMM0
									0x4D,// XMM0
									0xAF, 0x21,// VEX_Vbroadcastss_ymm_xmm
								0x37,// VW_3
									0x6D,// YMM0
									0x4D,// XMM0
						...
						0x0E,// VectorLength
							...
							0x07,// RM
								0x37,// VW_3
									0x6D,// YMM0
									0x4D,// XMM0
									0xB0, 0x21,// VEX_Vbroadcastsd_ymm_xmm
								0x37,// VW_3
									0x6D,// YMM0
									0x4D,// XMM0
				...
				0x0B,// MandatoryPrefix2_4
					...
					0x09,// W
						0x0E,// VectorLength
							0x29,// VHW_2
								0x4D,// XMM0
								0xB8, 0x21,// VEX_Vpdpbusd_xmm_xmm_xmmm128
							0x29,// VHW_2
								0x6D,// YMM0
								0xB9, 0x21,// VEX_Vpdpbusd_ymm_ymm_ymmm256
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
				...
				0x0B,// MandatoryPrefix2_4
					...
					0x09,// W
						0x0E,// VectorLength
							0x29,// VHW_2
								0x4D,// XMM0
								0xBA, 0x21,// VEX_Vpdpbusds_xmm_xmm_xmmm128
							0x29,// VHW_2
								0x6D,// YMM0
								0xBB, 0x21,// VEX_Vpdpbusds_ymm_ymm_ymmm256
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
				...
				0x0B,// MandatoryPrefix2_4
					...
					0x09,// W
						0x0E,// VectorLength
							0x29,// VHW_2
								0x4D,// XMM0
								0xBC, 0x21,// VEX_Vpdpwssd_xmm_xmm_xmmm128
							0x29,// VHW_2
								0x6D,// YMM0
								0xBD, 0x21,// VEX_Vpdpwssd_ymm_ymm_ymmm256
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
				...
				0x0B,// MandatoryPrefix2_4
					...
					0x09,// W
						0x0E,// VectorLength
							0x29,// VHW_2
								0x4D,// XMM0
								0xBE, 0x21,// VEX_Vpdpwssds_xmm_xmm_xmmm128
							0x29,// VHW_2
								0x6D,// YMM0
								0xBF, 0x21,// VEX_Vpdpwssds_ymm_ymm_ymmm256
						0x00,// Invalid
					0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x4A,// Gv_Ev
									0xE4, 0x23,// VEX_KNC_Undoc_r32_rm32_128_F3_0F38_W0_F0
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x4A,// Gv_Ev
									0xE6, 0x23,// VEX_KNC_Undoc_r32_rm32_128_F2_0F38_W0_F0
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								0x00,// Invalid
								0x4A,// Gv_Ev
									0xE8, 0x23,// VEX_KNC_Undoc_r32_rm32_128_F2_0F38_W0_F1
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x49,// VK_R_Ib
										0xEA, 0x23,// VEX_KNC_Kextract_kr_r64_imm8
										0x35,// RAX
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x4C,// K_Jb
										0xBB, 0x23,// VEX_KNC_Jkzd_kr_rel8_64
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x4C,// K_Jb
										0xBC, 0x23,// VEX_KNC_Jknzd_kr_rel8_64
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x32,// VK_RK
										0xC7, 0x23,// VEX_KNC_Kandnr_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x32,// VK_RK
										0xCC, 0x23,// VEX_KNC_Kmerge2l1h_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x32,// VK_RK
										0xCD, 0x23,// VEX_KNC_Kmerge2l1l_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x4D,// K_Jz
										0xCE, 0x23,// VEX_KNC_Jkzd_kr_rel32_64
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x4D,// K_Jz
										0xCF, 0x23,// VEX_KNC_Jknzd_kr_rel32_64
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x48,// Gq_HK_RK
										0xD3, 0x23,// VEX_KNC_Kconcath_r64_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x48,// Gq_HK_RK
										0xD4, 0x23,// VEX_KNC_Kconcatl_r64_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x00,// Invalid
						0x00,// Invalid
					0x00,// Invalid
						...
						0x09,// W
							0x47,// Options_DontReadModRM
								...
								0x04,// Bitness_DontReadModRM
									0x00,// Invalid
									0x32,// VK_RK
										0xD5, 0x23,// VEX_KNC_Kortest_kr_kr
								0x80, 0x80, 0x80, 0x08,// KNC
							0x32,// VK_RK
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								...
								0x07,// RM
									0x4A,// Gv_Ev
										0xDC, 0x23,// VEX_KNC_Popcnt_r32_r32
									0x00,// Invalid
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								...
								0x07,// RM
									0x4A,// Gv_Ev
										0xDE, 0x23,// VEX_KNC_Tzcnt_r32_r32
									0x00,// Invalid
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								...
								0x07,// RM
									0x4A,// Gv_Ev
										0xE0, 0x23,// VEX_KNC_Tzcnti_r32_r32
									0x00,// Invalid
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					...
					0x0E,// VectorLength
						0x47,// Options_DontReadModRM
							...
							0x04,// Bitness_DontReadModRM
								...
								0x07,// RM
									0x4A,// Gv_Ev
										0xE2, 0x23,// VEX_KNC_Lzcnt_r32_r32
									0x00,// Invalid
							0x80, 0x80, 0x80, 0x08,// KNC
						0x00,// Invalid
					0x00,// Invalid
