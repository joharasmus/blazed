...
namespace Blazed.Intel {
	...
	public sealed class Formatter {
		...
		/// Constructor
		/// </summary>
		public Formatter() : this(null, null, null) { }
		...
		public Formatter(ISymbolResolver? symbolResolver, IFormatterOptionsProvider? optionsProvider = null)
		...
		/// <param name="symbolResolver">Symbol resolver or null</param>
		/// <param name="optionsProvider">Operand options provider or null</param>
		public Formatter(FormatterOptions? options, ISymbolResolver? symbolResolver = null, IFormatterOptionsProvider? optionsProvider = null) {
			this.options = options ?? FormatterOptions.CreateFormatterOptions();
		...
		public void FormatMnemonic(in Instruction instruction, FormatterOutput output, FormatMnemonicOptions options) {
		...
		/// <param name="instruction">Instruction</param>
		/// <returns></returns>
		public int GetOperandCount(in Instruction instruction) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
		...
		/// <returns></returns>
		public bool TryGetOpAccess(in Instruction instruction, int operand, out OpAccess access) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
		...
		/// See <see cref="GetOperandCount(in Instruction)"/></param>
		/// <returns></returns>
		public int GetInstructionOperand(in Instruction instruction, int operand) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
			if ((uint)operand >= (uint)opInfo.OpCount)
		...
		/// <returns></returns>
		public int GetFormatterOperand(in Instruction instruction, int instructionOperand) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
		...
		/// <param name="operand">Operand number, 0-based. This is a formatter operand and isn't necessarily the same as an instruction operand.
		/// See <see cref="GetOperandCount(in Instruction)"/></param>
		public void FormatOperand(in Instruction instruction, FormatterOutput output, int operand) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
		...
		/// <param name="instruction">Instruction</param>
		/// <param name="output">Output</param>
		public void FormatOperandSeparator(in Instruction instruction, FormatterOutput output) {
			if (output is null)
		...
		/// <param name="instruction">Instruction</param>
		/// <param name="output">Output</param>
		public void FormatAllOperands(in Instruction instruction, FormatterOutput output) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
		...
		/// <param name="instruction">Instruction</param>
		/// <param name="output">Output</param>
		public void Format(in Instruction instruction, FormatterOutput output) {
			Debug.Assert((uint)instruction.Code < (uint)instrInfos.Length);
			var instrInfo = instrInfos[(int)instruction.Code];
			instrInfo.GetOpInfo(options, instruction, out var opInfo);
		...
		/// <returns></returns>
		public string Format(Register register) => ToRegisterString(register);
		...
		/// <returns></returns>
		public string FormatInt8(sbyte value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatInt16(short value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatInt32(int value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatInt64(long value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatUInt8(byte value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatUInt16(ushort value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatUInt32(uint value, in NumberFormattingOptions numberOptions) =>
		...
		/// <param name="numberOptions">Options</param>
		/// <returns></returns>
		public string FormatUInt64(ulong value, in NumberFormattingOptions numberOptions) =>
