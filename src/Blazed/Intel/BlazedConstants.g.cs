...
namespace Blazed.Intel {
	static partial class BlazedConstants {
		...
		internal const uint MvexStart = 4587;
		...
		internal const int MnemonicEnumCount = 1816;
