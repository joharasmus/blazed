...
namespace Blazed.Intel {
	static partial class BlazedConstants {
		...
		internal const int MaxCpuidFeatureInternalValues = 179;
		internal const MemorySize FirstBroadcastMemorySize = MemorySize.Broadcast32_Float16;
		internal const uint MvexStart = 4591;
		...
		internal const int CodeEnumCount = 4814;
		...
		internal const int MnemonicEnumCount = 1819;
