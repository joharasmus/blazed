...
namespace Blazed.Intel {
	static partial class BlazedConstants {
		...
		internal const uint MvexStart = 4536;
		...
		internal const int MnemonicEnumCount = 1797;
