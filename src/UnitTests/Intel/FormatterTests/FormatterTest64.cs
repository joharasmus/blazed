...
namespace UnitTests.Intel.FormatterTests {
	public sealed class FormatterTest64 : FormatterTest {
		...
		public static IEnumerable<object[]> Format_Data_MemAlways => FormatterTestCases.GetFormatData(64, "MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_MemDefault => FormatterTestCases.GetFormatData(64, "MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_MemMinimum => FormatterTestCases.GetFormatData(64, "MemMinimum");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemAlways => FormatterTestCases.GetFormatData(64, NonDecodedInstructions.Infos64, "NonDec_MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemDefault => FormatterTestCases.GetFormatData(64, NonDecodedInstructions.Infos64, "NonDec_MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemMinimum => FormatterTestCases.GetFormatData(64, NonDecodedInstructions.Infos64, "NonDec_MemMinimum");
#endif
		...
		public static IEnumerable<object[]> Format_Data_Misc => FormatterTestCases.GetFormatData(64, "Misc", isMisc: true);
	}
}
