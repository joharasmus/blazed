...
namespace UnitTests.Intel.FormatterTests {
	public sealed class FormatterTest32 : FormatterTest {
		...
		public static IEnumerable<object[]> Format_Data_MemAlways => FormatterTestCases.GetFormatData(32, "MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_MemDefault => FormatterTestCases.GetFormatData(32, "MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_MemMinimum => FormatterTestCases.GetFormatData(32, "MemMinimum");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemAlways => FormatterTestCases.GetFormatData(32, NonDecodedInstructions.Infos32, "NonDec_MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemDefault => FormatterTestCases.GetFormatData(32, NonDecodedInstructions.Infos32, "NonDec_MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemMinimum => FormatterTestCases.GetFormatData(32, NonDecodedInstructions.Infos32, "NonDec_MemMinimum");
#endif
		...
		public static IEnumerable<object[]> Format_Data_Misc => FormatterTestCases.GetFormatData(32, "Misc", isMisc: true);
	}
}
