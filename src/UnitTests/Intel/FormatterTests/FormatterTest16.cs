...
namespace UnitTests.Intel.FormatterTests {
	public sealed class FormatterTest16 : FormatterTest {
		...
		public static IEnumerable<object[]> Format_Data_MemAlways => FormatterTestCases.GetFormatData(16, "MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_MemDefault => FormatterTestCases.GetFormatData(16, "MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_MemMinimum => FormatterTestCases.GetFormatData(16, "MemMinimum");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemAlways => FormatterTestCases.GetFormatData(16, NonDecodedInstructions.Infos16, "NonDec_MemAlways");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemDefault => FormatterTestCases.GetFormatData(16, NonDecodedInstructions.Infos16, "NonDec_MemDefault");
		...
		public static IEnumerable<object[]> Format_Data_NonDec_MemMinimum => FormatterTestCases.GetFormatData(16, NonDecodedInstructions.Infos16, "NonDec_MemMinimum");
#endif
		...
		public static IEnumerable<object[]> Format_Data_Misc => FormatterTestCases.GetFormatData(16, "Misc", isMisc: true);
	}
}
